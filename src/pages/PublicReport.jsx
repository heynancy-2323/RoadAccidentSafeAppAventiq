...
const PublicReport = () => {
  ...
  return (
    <div className="flex-1 p-8 bg-[#F9FAFB] min-h-screen">
      ...
      <form onSubmit={handleSubmit} className="max-w-4xl mx-auto bg-white rounded-lg p-6 shadow">
        {/* Accident Location */}
        ...
        {/* Accident Details */}
        <h2 className="text-lg font-semibold my-4">Accident Details</h2>
        <div className="mb-4">
        ...
        {/* Evidence Upload */}
        <h2 className="text-lg font-semibold my-4">Evidence (Optional)</h2>
        ...
        {/* Contact Information */}
        <h2 className="text-lg font-semibold my-4">Contact Information (Optional)</h2>
        ...
        {/* CAPTCHA */}
        <h2 className="text-lg font-semibold my-4">Verification</h2>
